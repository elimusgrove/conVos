...
<!--            <img src="img/conVo.png" width="57" height="57" alt="logo" class="logo">-->
            <nav>
                <ul>
                    <li><a style="letter-spacing: 0.1em" href="#">Learn More</a></li>
    ...
    <section id="showcase">
        ...
        <p style="letter-spacing: 0.05em">Learn more with each conversation</p>
        <a style="letter-spacing: 0.05em" href="#" class="button">LEARN MORE</a>
    </section>
